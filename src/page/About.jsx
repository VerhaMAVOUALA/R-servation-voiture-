        ...
        <div className="container">
          <div className="about-content">
            <div className="about-image">
              <img src="https://images.unsplash.com/photo-1560177776-c19872fac4b7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80" alt="Notre équipe" />
            </div>
        ...
        <div className="container">
          <div className="mission-content">
            ...
            <div className="mission-image">
              <img src="https://images.unsplash.com/photo-1594170524773-e26c3149232c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="Notre mission" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="team-grid">
            <div className="team-member">
              <div className="member-image">
                <img src="https://randomuser.me/api/portraits/men/42.jpg" alt="Alexandre Dupont" />
              </div>
            ...
            <div className="team-member">
              <div className="member-image">
                <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Claire Bernard" />
              </div>
            ...
            <div className="team-member">
              <div className="member-image">
                <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Thomas Moreau" />
              </div>
              <h3>Thomas Moreau</h3>
